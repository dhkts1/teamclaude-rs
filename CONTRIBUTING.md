...
names. None of it belongs in code, in fixtures, in tests, in commit messages, or in PR titles or
...
2. Re-run the test.
3. Confirm the failure is the one you expected, not a compile error and not an unrelated assertion.
4. Restore the code.
5. Re-run, green.
