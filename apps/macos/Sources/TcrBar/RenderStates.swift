...
enum RenderStates {
    ...
    private static var realShapeFleet: Fleet {
        ...
        let base = fleet(
            "[\(account("alice@example.com", quota: "0.97", state: "near", plan: "Max 20x", orgUuid: "33333333-3333-3333-3333-333333333333")),"
                + "\(account("bob@example.com", quota: "0.42", state: "ok", plan: "Max 20x", orgUuid: "44444444-4444-4444-4444-444444444444"))]"
        )
        ...
        let busy = Session(
            ...
            requests: 1_654, inputTokens: 286_651, outputTokens: 188_239,
            cacheReadTokens: 328_915_843,
            tools: SessionTools(
                calls: 4_100, errors: 96, timeouts: 0,
                running: [
                    ToolCall(
                ...
                slowest: [
                    ToolCall(
                        ...
                        endedMs: msAgo(11 * 60), seconds: 96.4)
                ],
                overOneMinute: 26,
                byTool: [
                    ToolBucketRow(tool: "Bash", calls: 3_400, secondsP50: 3.0),
                    ToolBucketRow(tool: "Read", calls: 323, secondsP50: 2.3),
                    ToolBucketRow(tool: "Write", calls: 224, secondsP50: 0.9),
                    ToolBucketRow(tool: "Edit", calls: 153, secondsP50: 1.3),
                ]),
            costUsd: 308.38)
        let second = Session(
            ...
            requests: 837, inputTokens: 23_676, outputTokens: 92_434,
            cacheReadTokens: 203_259_191,
            tools: SessionTools(
                calls: 1_441, errors: 23, timeouts: 0,
                running: [
                    ToolCall(
                ...
                slowest: [
                    ToolCall(
                        ...
                        endedMs: msAgo(6 * 60), seconds: 61.2)
                ],
                overOneMinute: 15,
                byTool: [
                    ToolBucketRow(tool: "Bash", calls: 1_441, secondsP50: 1.4)
                ]),
            costUsd: 126.66)
        ...
        let warmups = (1...18).map { index in
            Session(
                ...
                requests: 2, inputTokens: 1_200, outputTokens: 28, cacheReadTokens: 9_745,
                costUsd: 0.13)
        }
        return Fleet(
            accounts: base.accounts, unreadable: base.unreadable,
